...
export default function AdminUsers() {
  ...
  const saveEdit = async () => {
    ...
    const d = await res.json();
    if (d.success) { setEditing(null); setMsg("تم تحديث المستخدم ✅"); load(); }
