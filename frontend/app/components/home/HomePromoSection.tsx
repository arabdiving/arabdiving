...
const PAGE_PROMOS: Record<string, {
  ...
  instructors: {
    icon: "🧑‍🏫", label: "دليل المدربين", href: "/instructors",
    desc: "اعرف مدربك قبل أول غطسة — بصمة تدريبية علمية تُظهر نقاط تميّز كل مدرب وتخصصاته وخبرته",
    bg: "linear-gradient(135deg,#134e4a 0%,#0891b2 100%)",
    accent: "#f5c218", cta: "تصفّح المدربين",
    bullets: ["بصمة تدريبية بمقاييس علمية", "الخبرة والتخصصات والمنظمة", "تواصل مباشر مع المدرب"],
  },
  travel: {
    icon: "✈️", label: "رحلتك: طيران وفنادق", href: "/travel",
    desc: "قارن الأسعار واكتشف أرخص شهر للسفر واحجز فندقك — كل ما حول غطستك في مكان واحد",
    bg: "linear-gradient(135deg,#0c4a6e 0%,#0891b2 100%)",
    accent: "#f5c218", cta: "خطط رحلتك",
    bullets: ["بحث طيران بأرخص الأسعار", "عروض فنادق البحر الأحمر", "الحجز الآمن لدى مزودين عالميين"],
  },
  standards: {
    icon: "🛡️", label: "معايير اعتماد المراكز", href: "/standards",
    desc: "هذا ما نشترطه على أي مركز غوص قبل أن نرشحه لك — معاييرنا كاملة ومعلنة، لأن الناصح الأمين لا يخفي شيئًا",
    bg: "linear-gradient(135deg,#0f172a 0%,#134e4a 100%)",
    accent: "#f5c218", cta: "اقرأ معاييرنا",
    bullets: ["قواعد المؤسس الخمس للسلامة", "خصوصية السيدات ومعدات محتشمة", "شفافية كاملة في الأسعار"],
  },
  training_fit: {
