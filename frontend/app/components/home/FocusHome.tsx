...
function FocusIso() {
  const ISO_CARDS = [
    ...
    },
    {
      ...
      body: "مستويان لمدرب الغوص يحددان ما يجب أن يتقنه قبل أن يُسمح له بالتدريس: مهارات مائية، علوم غوص، أساليب تعليم، وإدارة سلامة. مدرب PADI ومدرب SSI ومدرب CMAS يجتازون نفس السقف الأدنى.",
    },
    {
