  ...
  return (
    <main style={{ maxWidth: "760px", margin: "0 auto", padding: "clamp(20px,5vw,44px) 18px" }}>
      ...
      <div style={{ background: "white", borderRadius: "16px", padding: "clamp(18px,4vw,28px)", boxShadow: "0 10px 30px rgba(0,0,0,0.07)", borderTop: "5px solid var(--mid)" }}>
        ...
        {result !== null && (
          <div style={{ marginTop: "16px", padding: "18px", background: "#dcfce7", border: "2px solid #16a34a", borderRadius: "10px", textAlign: "center", color: "#15803d" }}>
            <div style={{ fontSize: "24px", fontWeight: 800 }}>الوزن التقريبي المطلوب: {result} كجم</div>
            <div style={{ fontSize: "13px", color: "#3f6212", marginTop: "4px" }}>(احتُسبت متغيرات كثافة الجسم والمعدات ونوع المياه)</div>
          </div>
        )}
